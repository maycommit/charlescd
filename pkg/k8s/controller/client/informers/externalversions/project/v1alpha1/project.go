...
import (
	...
	samplecontrollerv1alpha1 "github.com/maycommit/circlerr/pkg/k8s/controller/apis/project/v1alpha1"
	versioned "github.com/maycommit/circlerr/pkg/k8s/controller/client/clientset/versioned"
	internalinterfaces "github.com/maycommit/circlerr/pkg/k8s/controller/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/maycommit/circlerr/pkg/k8s/controller/client/listers/project/v1alpha1"
...
// one. This reduces memory projecttprint and number of connections to the server.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectV1alpha1().Projects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectV1alpha1().Projects(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecontrollerv1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1alpha1.Project{}, f.defaultInformer)
}
