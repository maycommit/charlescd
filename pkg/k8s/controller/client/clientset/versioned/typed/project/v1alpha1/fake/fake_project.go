...
import (
	...
	v1alpha1 "github.com/maycommit/circlerr/pkg/k8s/controller/apis/project/v1alpha1"
...
var projectsResource = schema.GroupVersionResource{Group: "circlerr.io", Version: "v1alpha1", Resource: "projects"}

var projectsKind = schema.GroupVersionKind{Group: "circlerr.io", Version: "v1alpha1", Kind: "Project"}
...
func (c *FakeProjects) Create(ctx context.Context, foo *v1alpha1.Project, opts v1.CreateOptions) (result *v1alpha1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(projectsResource, c.ns, foo), &v1alpha1.Project{})
...
func (c *FakeProjects) Update(ctx context.Context, foo *v1alpha1.Project, opts v1.UpdateOptions) (result *v1alpha1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(projectsResource, c.ns, foo), &v1alpha1.Project{})
...
func (c *FakeProjects) UpdateStatus(ctx context.Context, foo *v1alpha1.Project, opts v1.UpdateOptions) (*v1alpha1.Project, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(projectsResource, "status", c.ns, foo), &v1alpha1.Project{})
