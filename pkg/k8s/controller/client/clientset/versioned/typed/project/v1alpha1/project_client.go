...
// ProjectV1alpha1Client is used to interact with features provided by the samplecontroller.k8s.io group.
...
func NewForConfig(c *rest.Config) (*ProjectV1alpha1Client, error) {
	...
	return &ProjectV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ProjectV1alpha1Client for the given config and
...
func New(c rest.Interface) *ProjectV1alpha1Client {
	return &ProjectV1alpha1Client{c}
}
